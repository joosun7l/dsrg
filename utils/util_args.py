...
def get_args():
    ...
    parser.add_argument('--thre-fg', type=float, default=0.85, help='foreground threshold')
    parser.add_argument('--thre-bg', type=float, default=0.99, help='background threshold')
